...
@section('content')
    ...
    @endsection
    <form action="{{ route('crm.save-booking') }}" id="saveBookingForm" method="post" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="card-header align-items-center d-flex p-2">
                        ...
                        <div class="flex-shrink-0">
                            <a href="javascript:void(0)" onclick="add_pnr_rows()" class="btn btn-soft-success btn-sm float-end btn-label">
                                ...
                                {{-- <i class="ri-shield-user-line label-icon align-middle fs-16 me-2"></i> Add Pnr</a> --}}
                        </div>
                    </div><!-- end card header -->
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="deposit_date" value="{{today()}}" placeholder="DD-MM-YYYY" class="form-control flatpickr-date" data-provider="flatpickr" id="deposit_date" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 mb-3">
...
@section('script')
    <script>
        ...
        function add_pnr_rows(){
            ...
            initializeSelect2WithAjax('#pnrFlightSupplier_' + pnr_count, '{{ route('crm.get-vendors') }}', 'Search for Vendor');
        };
        ...
        function add_flight_rows() {
            ...
            initializeSelect2WithAjax('#flightsSupplier_' + flight_count, '{{ route('crm.get-vendors') }}', 'Search for Vendor');
