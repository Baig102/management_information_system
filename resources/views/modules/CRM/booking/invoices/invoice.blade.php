          ...
          <div class="row clearfix">
              <div class="col-lg-12">
                ...
                @if ($booking->refunded_amount > 0)
                    {{-- <h1 class="position-absolute text-danger text-uppercase display-3" style="rotate: -45deg; z-index: 99999; top: 30%; left: 25%; opacity: 0.5;"> {{ ($booking->deposite_amount > ($totalRefundedAmount + $totalServiceCharges)) ? "Partial Refunded" : (($booking->deposite_amount == ($totalRefundedAmount + $totalServiceCharges)) ? "Fully Refunded" : "") }} </h1> --}} {{-- top-50 position-absolute --}}
                @endif
                ...
                <table class="table no-border">
                    <tr>
                        <td style="border-top: none!important;">
                            ...
                            <table class="table invoice_header">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h6>Payment Status:
                                                @if ($total_balance_pending_amount > 0)
                            ...
                            {{-- <pre> {{ print_r(array_column($booking->flights, 'gds_no')) }} </pre> --}}
                            ...
                            @if (!empty($booking->visas[0]['visa_category']))
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach ($booking->visas as $visa)
                                        <tr>
                                            <td>
                                                <p>{{ $visa->visa_category }}</p>
                                            </td>
                                            <td>
                                                <p>{{ $visa->visa_country }}</p>
                                            </td>
                                        </tr>
                                    @endforeach
                                </table>
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach ($booking->prices as $price)
                                    ...
                                    <tr>
                                        <td>
                                            <p>{{ $price->booking_type }} ( {{ $price->quantity }} * {{ $price->sale_cost }} )</p>
                                        </td>
                                        <td>
                                            <p></p>
                                        </td>
                                        <td>
                                            <p>{{ $booking->currency }} {{ (!empty($price->total)) ? $price->total : 0 }}</p>
                                        </td>
                                    </tr>
                                    @endif
                                @endforeach
                                ...
                                @if (count($booking->otherCharges) > 0)
                                    ...
                                    @endphp
                                    {{-- <pre>{{ print_r($otherCharge) }}</pre> --}}
                                        <tr>
                                            <td>
                                                <p>{{ $oc_key+1 }}</p>
                                            </td>
                                            <td>
                                                <p>{{ $otherCharge->comments }}</p>
                                            </td>
                                            <td>
                                                <p>{{ $booking->currency . ' ' . $otherCharge->amount }}</p>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
                                <tr style="border-top: 2px solid;">
                                    ...
                                    <td>
                                        <p> {{ $booking->currency . ' ' . $booking->total_sales_cost+$otherChargesSum }} </p>
                                    </td>
                                </tr>
                            ...
                            <table class="table table-bordered">
                                ...
                                @endphp
                                {{-- <pre> {{ print_r($booking->otherCharges) }} </pre> --}}
                                @foreach ($booking->payments as $payment)
                                {{-- <pre> {{ print_r($payment) }} </pre> --}}
                                {{-- <pre> {{ print_r($payment->other_charges_id) }} </pre> --}}
                                {{-- {{ ($payment->other_charges_id != null) ? $payment->otherCharges->charges_type : "null"}} --}}
                                @php
                                ...
                                @endphp
                                    <tr>
                                        <td>
                                            <p>
                                                {{-- {{ $payment->installment_no == 0 ? 'Initial Payment' : $payment->installment_no }} --}}
                                        ...
                                        <td>
                                            <p>
                                            {{ $booking->currency . ' ' . $payment->reciving_amount }}
                                            @if ($payment->cc_charges > 0)
                                                {{ " (+ ".$payment->cc_charges ." CC)"}}
                                            @endif
                                            </p>
                                        </td>
                                        <td>
                                            <p>{{ ($payment->deposit_date != null) ? date('d M Y', strtotime($payment->deposit_date)) : '-' }}</p>
                                        </td>
                                        <td>
                                            @php
                                            ...
                                            {{-- <p>{{ $booking->currency . ' ' . $total_invoice_amount - $payment->reciving_amount }}</p> --}}
                                            {{-- <p>{{ $booking->currency . ' ' . $total_invoice_amount - ($payment->reciving_amount-$payment->cc_charges) }}</p> --}}
                                            <p>{{ $booking->currency . ' ' . $total_invoice_amount - $amount_without_cc }}</p>
                                            {{-- <p>{{ $booking->currency . ' ' . $total_invoice_amount - $payment->reciving_amount }}</p> --}}

                                            {{-- {{$total_invoice_amount."<br".$payment->reciving_amount."<br>".$payment->cc_charges}} --}}
                                            @php
                                        ...
                                        <td>
                                            <p class="d-none"> {{ $payment->remaining_amount == 0 ? 'Payment Completed' : '' }} {{-- date('d M Y', strtotime($payment->due_date)) --}}
                                            </p>
                                            <p> {{ $total_invoice_amount == 0 ? 'Payment Completed' : '' }} {{-- date('d M Y', strtotime($payment->due_date)) --}}
                                            </p>
                                        </td>
                                    </tr>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach ($booking->refunds->where('refund_status', 1) as $refund)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p> {{ str_replace("booking", "", $refund->refund_type).' Refund' }}</p>
                                            </td>
                                            <td>
                            ...
                            <h6>Your Total <strong>Outstanding</strong> Balanace Is: <span class='text-danger'><b>{{ $booking->currency .$booking->balance_amount+$booking->otherCharges->sum('remaining_amount'); }}</b></span>. Your cooperation in ensuring early payment is highly appreciated.</h6>
                            ...
                            <table class="table table-bordered">
                                ...
                                @if (count($booking->installmentPlan) > 0)
                                ...
                                @foreach ($booking->installmentPlan as $installment)
                                    {{-- <pre> {{ print_r($installment) }} </pre> --}}
                                    @if ($installment->is_received == 0 && $installment->amount > 0)
                                        @php
                                        $total_balance = $total_balance+$installment->amount
                                        @endphp
                                        <tr>
                                            <td>
                                                <p><span class='text-danger'> {{ "Installment # ".$installment->installment_number }} </span></p>
                                            </td>
                                            <td>
                                                <p> {!! $installment->is_received == 0 ? "<span class='text-danger'>" . $booking->currency . ' 0 </span>' : $booking->currency . ' ' . $installment->amount !!}
                                                </p>
                                            </td>
                                            <td>
                                                <p>{!! $installment->is_received == 0 ? "<span class='text-danger'>Pending</span>" : date('d M Y', strtotime($installment->received_on)) !!}
                                                </p>
                                            </td>
                                            <td>
                                                <p>{!! $installment->is_received == 0 ? "<span class='text-danger'>" . $booking->currency . ' ' . $installment->amount . '</span>' : $booking->currency . ' ' . ' 0' !!}
                                                </p>
                                            </td>
                                            <td>
                                    ...
                                    @endif
                                @endforeach
                                {{-- <pre>{{ $booking->otherCharges }}</pre> --}}
                                @foreach ($booking->otherCharges as $otherCharges)
                                    @if ($otherCharges->remaining_amount > 0)
                                        @php
                                        $total_balance = $total_balance + $otherCharges->remaining_amount;
                                        @endphp
                                        <tr>
                                            <td>
                                                <p><span class='text-danger'> {{ $otherCharges->charges_type }} </span></p>
                                            </td>
                                            <td>
                                                <p> <span class='text-danger'>{{ $booking->currency .$otherCharges->reciving_amount }}</span> </p>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <p>{!! $otherCharges->remaining_amount > 0 ? "<span class='text-danger'>" . $booking->currency . ' ' . $otherCharges->remaining_amount . '</span>' : $booking->currency . ' ' . ' 0' !!}
                                                </p>
                                            </td>
                                            <td>
                                                <p> - </p>
                                ...
                                <tr>
                                    ...
                                    <td><p><span class='text-danger'><b>{{ $booking->currency .$total_balance }}</b></span></p></td>
                                    <td></td>
                                </tr>
                                 @else
                                 <tr>
                                    <td colspan="3"><p><span class='text-danger'><b>Total Balance</b></span></p></td>
                                    <td><p><span class='text-danger'><b>{{ $booking->currency .$booking->balance_amount }}</b></span></p></td>
                                    <td></td>
                                </tr>
                                @endif
                            </table>
