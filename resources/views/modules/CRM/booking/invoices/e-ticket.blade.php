  ...
  <head>
      ...
      <!-- PRINT Css-->
        <link href="{{ URL::asset('build/css/bootstrap/bootstrap-print.css') }}"  rel="stylesheet" media="print"/>
  ...
  <body class="theme-blush"> {{-- onload="window.print()" --}}
      ...
      <div class="container-fluid">
                      ...
                      <tbody>
                          <tr class="">
                              <td style="border-top:0px" width="">
                                  <img src="{{ asset('images/companyLogos/' . $booking->company->logo) }}" width="250">
                              </td>
                              ...
                              <td style="border-top:0px; text-align: center; vertical-align: middle;" class="text-right" width="" style="">
                                  <p class="text-right">
                                        ...
                                        {{-- <span> {{$booking->company->phone}}</span> --}}
                                  </p>
                                  <p class="text-right">
                                    <span class="" style="color:#F58634 !important"><strong>Email:</strong></span>
                                    <span style="text-transform: lowercase !important;">{{$booking->company->email}}</span>
                                </p>
                              </td>
                          </tr>
                      </tbody>
                              ...
                              <div class="col-10 p-3" style="border-radius: 10px; background-color: #0F70B7;">
                                  <table class="table no-border">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($booking->passengers as $pKey => $passenger)
                                        <tr>
                                            <td class="no-border"><h5>{{ $passenger->last_name }}/{{ $passenger->first_name }} {{ $passenger->middle_name }}</h5></td>
                                            <td class="no-border"><h5>{{ $passenger->ticket_number }}</h5></td>
                                            <td class="no-border"><h5>{{ $passenger->pnr_code }}</h5></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                  </table>
                              </div>
                              {{-- <div class="col-2 qrCode" style="background-color: #ffffff; position: relative; top: -25px; text-align: center; border-radius: 7px;padding: 10px;"> --}}
                              <div class="col-lg-2 qrCode text-center"> {{-- style="position: relative; top: -30px; text-align: center;" --}}
                                <h4 class="" style="color:#F58634"><strong>Contact Us</strong></h4>
                                <img src="{{ asset('images/eTicket/e-ticket-qr.jpg')}}" width="200">
                              </div>
                          </div>
                      </div>
                  </div>
          ...
          @foreach ($booking->flights as $fKey => $flight)
                  ...
                  <div class="col-lg-12">
                      <div class="card no-border flightCard" style="border-radius: 10px;">
                          <div class="card-header text-white" style="border-radius: 10px 10px 0px 0px; background-color: #F58634;">
                              <h4 class="card-title mb-0"><strong> Flight {{ $fKey + 1 }} - {{ $flight->departure_airport }} to {{ $flight->arrival_airport }}</strong></h4>
                          </div>
                          <div class="card-body">
                              <div class="row p-2">
                                  <div class="col-lg-2">
                                      <h5>CARRIER</h5>
                                      <h5><strong>{{ $flight->air_line_name }}</strong></h5>
                                      {{-- <h6><strong>{{ explode(' ', $flight->flight_number)[0] ?? '' }}</strong></h6> --}}
                                  </div>
                                  <div class="col-lg-2">
                                      <h5>FLIGHT NO</h5>
                                      <h5><strong>{{ $flight->flight_number }}</strong></h5>
                                      {{-- <h6><strong>{{ explode(' ', $flight->flight_number)[1] ?? '' }}</strong></h6> --}}
                                  </div>
                                  <div class="col-lg-3">
                                      <h5>DEPARTURE</h5>
                                      <h5 class="mb-2"><strong>{{ $flight->departure_time }}</strong></h5>
                                      <h5 class="mb-0 fw-medium text-truncate">{{ $flight->departure_airport }}</h5>
                                      <h5 class="mb-0">{{ date('d-M-Y', strtotime($flight->departure_date)) }}</h5>
                                  </div>
                                  <div class="col-lg-2 text-left">
                                      {{-- <spain class="text-danger display-6"><i class="ri-plane-line"></i></spain> --}}
                                      <div class="mt-3">

                                          <img src="{{ asset('images/eTicket/airplane.png')}}" width="40">
                                      </div>
                                  </div>
                                  <div class="col-lg-3">
                                      <h5>ARRIVAL</h5>
                                      <h5 class="mb-2"><strong>{{ $flight->arrival_time }}</strong></h5>
                                      <h5 class="mb-0 fw-medium text-truncate">{{ $flight->arrival_airport }}</h5>
                                      <h5 class="mb-0">{{ date('d-M-Y', strtotime($flight->arrival_date)) }}</h5>
                                  </div>
                              </div>
                          </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="row">
                                        ...
                                        <div class="col-2">
                                          <h5>BAG</h5>
                                          <h5 class="mb-0"><strong>{{ $flight->number_of_baggage}}</strong></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6 text-right d-none">
                                    @if ($loop->last)
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <img src="{{ asset('images/eTicket/bags.png')}}" width="100">
                                            </div>
                                            <div class="col-3">
                                                <img src="{{ asset('images/eTicket/car-rental.png')}}" width="100">
                                            </div>
                                            <div class="col-3">
                                                <img src="{{ asset('images/eTicket/map-pin.png')}}" width="100">
                                            </div>
                                            <div class="col-3">
                                                <img src="{{ asset('images/eTicket/customer-support.png')}}" width="100">
                                            </div>
                                        </div>
                                    @endif
                                </div>
          ...
          <div class="row clearfix mt-3">
            <div class="col-12 text-center">
                <img class="rounded material-shadow" width="100%" src="{{ asset('images/eTicket/banner.png')}}" data-holder-rendered="true">
            </div>
          </div>
          <div class="row clearfix mt-3">
                  ...
                  <div class="divFooter row d-none" style="margin: 0 auto;width: 100%; ">
                      <table class="table">
                          <tr>
                              ...
                              <td class="text-right"><img src="{{ asset('images/iata-logo-new.png') }}" width="100"></td>
                          </tr>
                      </table>
                  </div>
              </div>
