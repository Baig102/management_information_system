...
<form id="paymentForm">
    ...
    <div class="modal-body">
        ...
        <table class="table table-bordered table-nowrap">
            ...
            <tbody>
                @foreach ($booking->payments as $payment)
                    @if (empty($payment->other_charges_id))
                    <tr>
        ...
        @else
            ...
            @if($booking->payments->contains('is_approved', 0))
            ...
            @elseif (round($totalInstallmentAmount, 2) !== round($booking->balance_amount, 2))
                <div class="alert alert-danger alert-border-left alert-dismissible fade show mb-xl-0 material-shadow" role="alert">
            ...
            @elseif ($booking->total_installment != $totalInstallemts)
                <div class="alert alert-danger alert-border-left alert-dismissible fade show mb-xl-0 material-shadow" role="alert">
            ...
            @else
                ...
                @if ($pendingInstallment->count() > 0)

                    @foreach ($pendingInstallment as $installment_plan)
                    <div class="row mb-3">
                        <div class="col-lg-3 col-md-6 mb-3">
                            <label>Installment Number</label>
                            <div class="input-group">
                                <span class="input-group-text px-2 py-1"><i class="ri-money-pound-circle-line fs-5"></i></span>
                                <input type="number" class="form-control installment_number" id="installment_number" name="installment_number" value="{{ $installment_plan->installment_number }}" placeholder="Enter Deposite Amount" readonly>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text px-2 py-1"><i class="ri-money-pound-circle-line fs-5"></i></span>
                                <input type="number" class="form-control installment_amount" id="installment_amount" name="installment_amount" value="{{ $installment_plan->amount }}" placeholder="Enter Installment Amount" step="0.01" required readonly>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="due_date" value="{{ $installment_plan->due_date }}" placeholder="DD-MM-YYYY" class="form-control" id="due_date" autocomplete="off" readonly required>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <input type="hidden" name="installment_id" id="" value="{{ $installment_plan->id }}">
                    </div>
                    <div class="row mb-3">
                        <div class="col-lg-12">
    ...
    <div class="modal-footer">
        @if ($pendingInstallment->count() > 0 && round($totalInstallmentAmount, 2) == round($booking->balance_amount, 2))
