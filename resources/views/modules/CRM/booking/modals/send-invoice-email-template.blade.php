...
<div class="modal-body" id="emailTemplateContent">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <h6>Dear Valued Passenger,<br>Greetings from {{ $booking->company->name }}</h6>
...
<p> Please note by replying "yes" or "All details are correct" or " I Agree ok " and any other confirmation to this email means you agree to our terms and conditions and the details or your booking including names, flight details and other package details are correct.</p>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <h6 class="text-primary">{{ $booking->company->name }}</h6>

            <p class="mb-0">{{ $booking->company->address }}</p>

            <p class="mb-0"><strong>Complain Line:</strong> {{ $booking->company->phone }}</p>

            <p class="mb-0"><strong>Email:</strong> {{ $booking->company->email }}</p>
        ...
        <div class="col-lg-6">
            ...
            <p class="mb-0"><strong>Invoice Date:</strong> {{ date('d-m-Y', strtotime($booking->booking_date)) }}</p>

            <p class="mb-0"><strong>Invoice No:</strong> {{ $booking->booking_prefix . $booking->booking_number }}</p>
                ...
                <table class="table table-borderless table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="mb-0 pb-0">{!! $booking->flight_pnr !!}</td>
            ...
            <div class="col-lg-12 mb-3">
                ...
                <table class="table table-bordered table-sm">
                    ...
                    @foreach ($booking->hotels as $hotel)
                        <tr>
                            <td>
                                <p class="mb-0 pb-0">{{ $hotel['hotel_name'] }}</p>
                            </td>
                            <td>
                                <p class="mb-0 pb-0">{{ date('d M Y', strtotime($hotel['check_in_date'])) }}</p>
                            </td>
                            <td>
                                <p class="mb-0 pb-0">{{ date('d M Y', strtotime($hotel['check_out_date'])) }}</p>
                            </td>
                            <td>
                                <p class="mb-0 pb-0">{{ $hotel['total_nights'] }}</p>
                            </td>
                            <td>
                                <p class="mb-0 pb-0">{{ $hotel['meal_type'] }}</p>
                            </td>
                            <td>
                                <p class="mb-0 pb-0">{{ $hotel['room_type'] }}</p>
                            </td>
                        </tr>
                    @endforeach
            ...
            <div class="col-lg-12 mb-3">
                ...
                <table class="table table-bordered table-sm">
                    ...
                    @foreach ($booking->transports as $transport)
                        <tr>
                            <td>
                                <p class="mb-0 pb-0">{{ $transport['transport_type'] }}</p>
                            </td>
                            <td>
                                <p class="mb-0 pb-0">{{ $transport['airport'] }}</p>
                            </td>
                            <td>
                                <p class="mb-0 pb-0">{{ $transport['location'] }}</p>
                            </td>
                            <td>
                                <p class="mb-0 pb-0">{{ date('H:i', strtotime($transport['time'])) }}</p>
                            </td>
                            <td>
                                <p class="mb-0 pb-0">{{ $transport['car_type'] }}</p>
                            </td>
                        </tr>
                    @endforeach
            ...
            <div class="col-lg-12 mb-3">
                ...
                <table class="table table-bordered table-sm">
                    ...
                    @foreach ($booking->visas as $visa)
                        <tr>
                            <td>
                                <p class="mb-0 pb-0">{{ $visa->visa_category }}</p>
                            </td>
                            <td>
                                <p class="mb-0 pb-0">{{ $visa->visa_country }}</p>
                            </td>
                        </tr>
                    @endforeach
                    ...
                    <tbody>
                        ...
                        @if ($price->quantity != null)
                            ...
                            <tr>
                                ...
                                <th class="mb-0 pb-0">{{ $price->booking_type }} </th>

                                <th colspan="3" class="mb-0 pb-0"> {{ $price->quantity . ' * ' . $price->sale_cost }}</th>

                                <td class="mb-0 pb-0">:</td>

                                <td class="mb-0 pb-0">{{ $booking->currency . $price->total }}</td>
                       ...
                       @endphp
                        @if (count($booking->otherCharges) > 0)
                            ...
                            @endphp
                                <tr>
                                    ...
                                    <th class="mb-0 pb-0">{{ $other_charge->charges_type  }} </th>
                                    {{-- <th class="mb-0 pb-0">{{ $other_charge->comments  }} </th> --}}

                                    <th colspan="3" class="mb-0 pb-0"></th>

                                    <td class="mb-0 pb-0">:</td>

                                    <td class="mb-0 pb-0">{{ $booking->currency . $other_charge->amount }} </td>
                        ...
                        <tr>
                            ...
                            {{-- <td class="mb-0 pb-0">{{ $booking->currency . $booking->total_sales_cost }} </td> --}}
                            <td class="mb-0 pb-0">{{ $booking->currency . $booking->total_sales_cost+$total_other_charges }} </td>
                        ...
                        <tr>
                            ...
                            {{-- <td class="mb-0 pb-0">{{ $booking->currency . $booking->deposite_amount }} </td> --}}
                            <td class="mb-0 pb-0">{{ $booking->currency . $booking->deposite_amount+$booking->other_charges }} </td>
                        ...
                        <tr>
                            ...
                            <td class="mb-0 pb-0">{{ $booking->currency . $booking->balance_amount + ($total_other_charges-$booking->other_charges) }} </td>

                        </tr>

                        {{-- <tr>

                            <th class="mb-0 pb-0">Payment Due Date</th>

                            <th colspan="3" class="mb-0 pb-0"></th>

                            <td class="mb-0 pb-0">:</td>

                            <td class="mb-0 pb-0">{{ ($booking->balance_amount > 0) ? date("d M Y", strtotime($next_payment_due_date)) : "Payment Completed"; }} </td>
                    ...
                    <tbody>
                        ...
                        {{-- <pre> {{ print_r($payment) }} </pre> --}}
                            <tr>
                                ...
                                <th colspan="2" class="mb-0 pb-0">{{ date("d M Y", strtotime($payment->deposit_date)) }}</th>

                                <td colspan="2" class="mb-0 pb-0">{{ $payment->payment_method }}</td>

                                <td colspan="2" class="mb-0 pb-0">{{ $booking->currency . $payment->reciving_amount }}@if ($payment->cc_charges > 0)
...
<div class="modal-footer">
    ...
    {{-- <button type="button" class="btn btn-primary" id="copyToClipboardButton" onclick="copy_to_clip_boad()">Copy to Clipboard</button> --}}
