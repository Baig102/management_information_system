<form id="refundForm">
    ...
    <div class="modal-header border-bottom border-2 py-2 bg-secondary-subtle">
        <h5 class="modal-title" id="fullscreeexampleModalLabel">Add Refund | Booking Number: {{ $booking->booking_prefix . $booking->booking_number }}</h5>
        ...
        <table class="table table-bordered table-nowrap table-sm">
            ...
            <tbody>
                <tr>
                    ...
                    <td><span class="text-primary">{{ $booking->currency . ' ' . number_format($booking->margin, 2) }}</span></td>
                    <td><span class="text-success">{{ $booking->currency . ' ' . number_format($booking->deposite_amount, 2) }}</span></td>
                    <td><span class="text-danger">{{ $booking->currency . ' ' . number_format($booking->balance_amount, 2) }}</span></td>
            ...
            <div class="row mb-3">
                <div class="col-lg-3 col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control paid_amount" id="paid_amount" name="paid_amount" value="{{ $booking->deposite_amount-$booking->refunded_amount }}" placeholder="Enter Deposite Amount" step="0.01" readonly>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-3">
                    <label>Margin</label>
                    <div class="input-group">
                        <span class="input-group-text px-2 py-1"><i class="ri-money-pound-circle-line fs-5"></i></span>
                        <input type="number" class="form-control margin_value" id="margin_value" name="margin_value" value="{{ $booking->margin }}" step="0.01" readonly>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-3">
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text px-2 py-1"><i class="ri-money-pound-circle-line fs-5"></i></span>
                        <input type="number" class="form-control refundable_amount" id="refundable_amount" name="refundable_amount" value="{{ $booking->deposite_amount-$booking->refunded_amount-$booking->margin }}" placeholder="Enter Refundable Amount" step="0.01" required readonly>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text px-2 py-1"><i class="ri-money-pound-circle-line fs-5"></i></span>
                        <input type="number" class="form-control refunded_amount" id="refunded_amount" name="refunded_amount" value="0" placeholder="Enter Refunded Amount" step="0.01" max="{{ $booking->deposite_amount-$booking->refunded_amount-$booking->margin }}" readonly required>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        $('input[name="refund_type"]').change(function() {
            ...
            $.ajax({
                url: '{{ route("crm.get-data-for-refund") }}',
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
