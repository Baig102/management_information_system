                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="hstack gap-2 justify-content-end">
                            <a href="{{ route('crm.dashboard') }}" class="btn btn-danger"> <i class="ri-restart-line me-1 align-bottom"></i> Reset </a>
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                    data-target="{{ $counts['total_sales'] }}">0</span></h4>
            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-4">£<span class="counter-value"
                                    data-target="{{ $counts['total_sales_value'] }}">0</span></h4>
            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-4">£<span class="counter-value"
                                    data-target="{{ $counts['total_deposits'] }}">0</span>
                            </h4>
            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-4">£<span class="counter-value"
                                    data-target="{{ $counts['total_balance_pending'] }}">0</span>
                            </h4>
            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-4">£<span class="counter-value"
                                    data-target="{{ $counts['total_refunds'] }}">0</span>
                            </h4>
                            <a href="" class="text-decoration-underline d-none">Withdraw money</a>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
...
@section('script')
    ...
    {{-- <script src="{{ URL::asset('build/js/crm-dashboard.js') }}"></script> --}}
    <script>
        $(function() {
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const chartData = @json($supplierWiseSales);
