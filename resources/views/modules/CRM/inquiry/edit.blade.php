    ...
    <form action="{{ route('crm.save-booking') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                ...
                                <input type="text" name="booking_date" value="{{ $booking->booking_date }}" placeholder="DD-MM-YYYY" class="form-control flatpickr-date" data-provider="flatpickr" id="booking_date" autocomplete="off" required>
                            </div>

                            <div class="col-lg-2">
                                <label for="ticket_deadline" class="form-label">Ticketing Deadline<span class="text-danger"> *</span></label>
                                <input type="text" name="ticket_deadline" value="{{ $booking->ticket_deadline }}" placeholder="DD-MM-YYYY" class="form-control flatpickr-date" data-provider="flatpickr" id="ticket_deadline" autocomplete="off" required>
                            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-2">
                                <label for="title_1" class="form-label">Title<span class="text-danger"> *</span></label>
                                <select class="select2 form-control-sm" id="title_1" name="title">
                                    <option></option>
                                    <option value="Mr." {{ $booking->title == 'Mr.' ? 'selected' : "" }}>Mr.</option>
                                    <option value="Ms." {{ $booking->title == 'Ms.' ? 'selected' : "" }}>Ms.</option>
                                    <option value="Mrs." {{ $booking->title == 'Mrs.' ? 'selected' : "" }}>Mrs.</option>
                                    <option value="Miss." {{ $booking->title == 'Miss.' ? 'selected' : "" }}>Miss.</option>
                                    <option value="Mstr." {{ $booking->title == 'Mstr.' ? 'selected' : "" }}>Mstr.</option>
                                </select>
                            </div>
                            <div class="col-lg-2">
                                <label for="first_name_1" class="form-label">First Name<span class="text-danger"> *</span></label>
                                <input type="text" name="first_name" value="{{ $booking->first_name }}" class="form-control" placeholder="First Name" id="first_name_1" autocomplete="off" required>
                            </div>
                            <div class="col-lg-2">
                                <label for="middle_name_1" class="form-label">Middle Name</label>
                                <input type="text" name="middle_name" value="{{ $booking->middle_name }}" class="form-control"
                                    placeholder="Middle Name" id="middle_name_1" autocomplete="off">
                            </div>
                            <div class="col-lg-2">
                                <label for="last_name_1" class="form-label">Last Name</label>
                                <input type="text" name="last_name" value="{{ $booking->last_name }}" class="form-control"
                                    placeholder="Last Name" id="last_name_1" autocomplete="off">
                            </div>
                            <div class="col-lg-2">
                                <label for="date_of_birth_1" class="form-label">Date of Birth<span class="text-danger"> *</span></label>
                                <input type="text" name="date_of_birth" value="{{ $booking->date_of_birth }}" class="form-control cleave-date" placeholder="DD-MM-YYYY" id="date_of_birth_1"
                                    autocomplete="off" required>
                            </div>
                            <div class="col-lg-2">
                                <label for="nationality" class="form-label">Nationality</label>
                                <input type="text" name="nationality" value="{{ $booking->nationality }}" class="form-control" placeholder="Nationality" id="nationality" autocomplete="off">
                            </div>
                            <div class="col-lg-2 mt-2">
                                <label for="mobile_number" class="form-label">Mobile Number<span class="text-danger"> *</span></label>
                                <input type="number" name="mobile_number" value="{{ $booking->mobile_number }}" class="form-control chose_multi" placeholder="Mobile Number" id="mobile_number" autocomplete="off" required>
                            </div>
                            <div class="col-lg-2 mt-2">
                                <label for="email" class="form-label">Email<span class="text-danger"> *</span></label>
                                <input type="text" name="email" value="{{ $booking->email }}" class="form-control chose_multi" placeholder="Email" id="multi_email" data-choices data-choices-limit="10" data-choices-removeItem autocomplete="off" required>
                            </div>
                            <div class="col-lg-2 mt-2">
                                <label for="address" class="form-label">Address<span class="text-danger"> *</span></label>
                                <input type="text" name="address" value="" class="form-control" placeholder="Address" id="address" autocomplete="off" required>
                            </div>
                            <div class="col-lg-2 mt-2">
                                <label for="post_code" class="form-label">Post Code</label>
                                <input type="number" name="post_code" value="{{ $booking->post_code }}" class="form-control" placeholder="Post Code" id="post_code" max="10" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex p-2">
                        ...
                        <div class="flex-shrink-0">
                            <a href="javascript:void(0)" onclick="add_hotel_rows()" class="btn btn-soft-success btn-sm float-end btn-label"><i class="ri-hotel-line label-icon align-middle fs-16 me-2"></i> Add Hotel</a>
                    ...
                    <div class="card-body" id="hotel_details">
                        ...
                        <div class="row clearfix hotel_info mb-3" id="hotel_info_{{$hotel->id}}">

                            <div class="col-lg-2 col-md-6 mb-3">
                                <label>Hotel Name<span class="text-danger"> *</span></label>
                                <input type="text" class="form-control" name="hotel[{{$hotel->id}}][hotel_name]" value="{{ $hotel->hotel_name }}" placeholder="Hotel Name"
                                    required>
                            </div>
                            <div class="col-lg-2 col-md-6 mb-3">
                                <label>Check in date<span class="text-danger"> *</span></label>
                                <input type="text" class="form-control flatpickr check_in_date" id="check_in_date_{{$hotel->id}}"
                                    name="hotel[{{$hotel->id}}][check_in_date]" value="{{ $hotel->check_in_date }}" placeholder="Check in date" required>
                            </div>
                            <div class="col-lg-2 col-md-6 mb-3">
                                <label>Check out Date<span class="text-danger"> *</span></label>
                                <input type="text" class="form-control flatpickr check_out_date" id="check_out_date_{{$hotel->id}}"
                                    name="hotel[{{$hotel->id}}][check_out_date]" value="{{ $hotel->check_out_date }}" placeholder="Check out date" required>
                            </div>
                            <div class="col-lg-2 col-md-6 mb-3">
                                <label>Total nights<span class="text-danger"> *</span></label>
                                <input type="text" class="form-control total_nights" id="total_nights_{{$hotel->id}}"
                                    name="hotel[{{$hotel->id}}][total_nights]" value="{{ $hotel->total_nights }}" placeholder="Total nights" readonly="" required>
                            </div>
                            <div class="col-lg-2 col-md-6 mb-3">
                                <label>Meal Type<span class="text-danger"> *</span></label>
                                <input type="text" class="form-control" name="hotel[{{$hotel->id}}][meal_type]" value="{{ $hotel->meal_type }}" placeholder="Meal Type"
                                    required>
                            </div>
                            <div class="col-lg-2 col-md-6 mb-3">
                                <label>Room Type<span class="text-danger"> *</span></label>
                                <input type="text" class="form-control" name="hotel[{{$hotel->id}}][room_type]" value="{{ $hotel->room_type }}" placeholder="Room Type"
                                    required>
                            </div>
                            <div class="col-lg-2 col-md-6 mb-3">
                                <label>HCN <small>Hotel Confirmation Number</small></label>
                                <input type="text" class="form-control" name="hotel[{{$hotel->id}}][hotel_confirmation_number]" value="{{ $hotel->hotel_confirmation_number }}"
                                    placeholder="HCN">
                            </div>
                            <div class="col-lg-2 col-md-6 mb-3">
                                <label>Sale Cost<span class="text-danger"> *</span></label>
                                <input type="number" class="form-control hotel_sale_cost" name="hotel[{{$hotel->id}}][sale_cost]" value="{{ $hotel->sale_cost }}"
                                    placeholder="Sale Cost" step="0.01" required="">
                            </div>
                            <div class="col-lg-2 col-md-6 mb-3">
                                <label>Net Cost<span class="text-danger"> *</span></label>
                                <input type="number" class="form-control hotel_net_cost" name="hotel[{{$hotel->id}}][net_cost]" value="{{ $hotel->net_cost }}" placeholder="Net Cost" step="0.01" required="">
                            </div>
                            <div class="col-lg-2 col-md-6">
                                <label>Supplier<span class="text-danger"> *</span></label>
                                <select class="hotel_supplier" id="hotelSupplier_{{$hotel->id}}" name="hotel[{{$hotel->id}}][supplier]"
                                    data-placeholder="select hotel supplier" required>
                                    <option value="{{ $hotel->supplier }}">{{ $hotel->supplier }}</option>
                                </select>

                            </div>
                            <div class="col-lg-2 col-md-6 mb-3">
                                <button type="button" class="btn btn-danger btn-label waves-effect waves-light btn-soft-danger btn-sm clone_row mt-4"
                                    onclick="remove_row(hotel_info_{{$hotel->id}}, {{$hotel->id}}, 'hotels')"><i
                                        class="ri-indeterminate-circle-line label-icon align-middle fs-16 me-2"></i>Remove</button>
                            </div>
                        </div>

                        @endforeach

                        <input type="hidden" name="hotel_count" id="hotel_details_count" value="{{ count($booking->hotels)+1 }}">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body" id="payment_terms">
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-3 col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control deposite_amount" id="deposite_amount" name="deposite_amount" onkeyup="calculate_balance_amount()" placeholder="Enter Deposite Amount" step="0.01" required>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <div class="tab-content">
                            {{-- <div class="tab-pane" id="cash_transfer" role="tabpanel">
                                <div class="row clearfix">
                                    <div class="col-lg-4 col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text px-2 py-1"><i class="ri-money-pound-circle-line fs-5"></i></span>
                                            <input type="number" class="form-control deposite_amount" id="deposite_amount" name="deposite_amount" placeholder="Enter Deposite Amount" step="0.01" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6 mb-3">
                                        <label>Balance Amount</label>
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text px-2 py-1"><i class="ri-time-line fs-5"></i></span>
                                            <input type="text" class="form-control cleave-date" data-provider="flatpickr" data-date-format="d M, Y" data-minDate="25 12, 2021" data-maxDate="29 12,2021">
                                            <input type="text" name="deposit_date" value="" class="form-control cleave-date" placeholder="DD-MM-YYYY" id="deposit_date" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                            </div> --}}
                            ...
                            {{-- <div class="tab-pane" id="credit_limit_transfer" role="tabpanel">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Booking Comments</h4>
                    </div><!-- end card header -->
...
@section('script')
    <script>
        $(function() {
            ...
            initializeSelect2WithAjax('select.hotel_supplier', '{{ route('ams.get-vendors','Hotels') }}', 'Search for Vendor');
        })
        ...
        function add_hotel_rows() {
            ...
            const $dateInput = $(`
                ...
                <div class="col-lg-2 col-md-6 mb-3">
                    <label>Sale Cost<span class="text-danger"> *</span></label>
                    <input type="number" class="form-control hotel_sale_cost" name="hotel[${hotel_count}][sale_cost]" value="" placeholder="Sale Cost" step="0.01" required="">
                </div>
                <div class="col-lg-2 col-md-6 mb-3">
                    <label>Net Cost<span class="text-danger"> *</span></label>
                ...
                <div class="col-lg-2 col-md-6 mb-3">
                    <button type="button" class="btn btn-danger btn-label waves-effect waves-light btn-soft-danger btn-sm clone_row mt-4" onclick="remove_row(hotel_info_${hotel_count})"><i class="ri-indeterminate-circle-line label-icon align-middle fs-16 me-2"></i>Remove</button>
                </div>
            `);
        ...
        function add_transport_rows() {
            ...
            const $dateInput = $(`
                ...
                <div class="col-lg-2 col-md-6 mb-3">
                    <label>Sale Cost<span class="text-danger"> *</span></label>
                    <input type="number" class="form-control transport_sale_cost" name="transport[${transport_count}][sale_cost]" value="" placeholder="Sale Cost" step="0.01" required="">
                </div>
                <div class="col-lg-2 col-md-6 mb-3">
                    <label>Net Cost<span class="text-danger"> *</span></label>
                ...
                <div class="col-lg-2 col-md-6 mb-3">
                    <div class="col-lg-4 col-md-6 mb-3">
                        <button type="button" class="btn btn-danger btn-label waves-effect waves-light btn-soft-danger btn-sm clone_row mt-4" onclick="remove_row(transport_info_${transport_count})"><i class="ri-indeterminate-circle-line label-icon align-middle fs-16 me-2"></i>Remove</button>
                    </div>
                </div>
            `);
            ...
            initializeSelect2WithAjax('#transportSupplier_' + transport_count, '{{ route('ams.get-vendors') }}', 'Search for Vendor');
        ...
        function remove_row(row_id, id=null, module=null) {
            var $row = $(row_id);

            console.log($(row_id), id, module);
