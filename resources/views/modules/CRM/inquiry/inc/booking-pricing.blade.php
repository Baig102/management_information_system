        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="input-group">
                        <span class="input-group-text px-2 py-1"><i class="ri-money-pound-circle-line fs-5"></i></span>
                        <input type="number" class="form-control net_cost" onkeyup="calculations(this.id)" id="netCost_7" name="booking_pricing[7][flight_price]" placeholder="Sale Cost" step="0.01">
                    </div>
                </td>
                <td>
                    <div class="input-group">
                        <span class="input-group-text px-2 py-1"><i class="ri-money-pound-circle-line fs-5"></i></span>
                        <input type="number" class="form-control net_price" onkeyup="calculations(this.id)" id="netPrice_7" name="booking_pricing[7][flight_net_price]" placeholder="Net Cost" step="0.01">
                    </div>
                </td>
                <td>
                    <div class="input-group">
            ...
            <tr>
                ...
                <td>
                    <div class="input-group">
                        <span class="input-group-text px-2 py-1"><i class="ri-money-pound-circle-line fs-5"></i></span>
                        <input type="number" class="form-control net_cost" onkeyup="calculations(this.id)" id="netCost_10" name="booking_pricing[10][flight_price]" placeholder="Sale Cost" step="0.01">
                    </div>
                </td>
                <td>
                    <div class="input-group">
                        <span class="input-group-text px-2 py-1"><i class="ri-money-pound-circle-line fs-5"></i></span>
                        <input type="number" class="form-control net_price" onkeyup="calculations(this.id)" id="netPrice_10" name="booking_pricing[10][flight_net_price]" placeholder="Net Cost" step="0.01">
                    </div>
                </td>
                <td>
                    <div class="input-group">
                        <span class="input-group-text px-2 py-1"><i class="ri-team-line fs-5"></i></span>
                        <input type="number" class="form-control quantity" onkeyup="calculations(this.id)" id="quantity_10" name="booking_pricing[10][quantity]" placeholder="Quantity" step="0.01">
                    </div>
                </td>
                <td>
                    <div class="input-group">
