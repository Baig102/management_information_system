...
<form action="{{ route('hrm.company-update') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Company Name" id="name" value="{{ $company->name }}" name="name">
                            </div>
                        </div><!--end col-->
                        <div class="col-lg-2">
                            <div class="mb-3">
                                <label for="invoice_prefix" class="form-label">Invoice Prefix</label>
                                <input type="text" class="form-control" placeholder="Enter Invoice Prefix" id="invoice_prefix" value="{{ $company->invoice_prefix }}" name="invoice_prefix" max="5">
                            </div>
                        </div><!--end col-->
                        <div class="col-lg-2">
                            <div class="mb-3">
                                <label for="booking_number" class="form-label">Booking Number</label>
                                <input type="number" class="form-control" placeholder="Enter Booking Number" id="booking_number" value="{{ $company->booking_number }}" name="booking_number">
                            </div>
                        </div><!--end col-->
                            ...
                            <div class="mb-3">
                                <label for="logo" class="form-label">
                                    ...
                                    @if(!empty($company->logo))
                                        <span>
                                            <a href="{{ asset('images/companyLogos/' . $company->logo) }}" target="_blank">View Logo</a>
                                        </span>
                                    @endif
                                </label>
                                <input class="form-control" type="file" id="logo" value="{{ $company->logo }}" name="logo">
                        ...
                        <div class="col-lg-2">
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" placeholder="Phone Number" id="phone" value="{{ $company->phone }}" name="phone">
                            </div>
                        </div><!--end col-->
                        <div class="col-lg-2">
                            <div class="mb-3">
                                <label for="email" class="form-label">Email Address</label>
                                <input type="email" class="form-control" placeholder="example@gamil.com" id="email" value="{{ $company->email }}" name="email">
                            </div>
                        </div><!--end col-->
                        <div class="col-lg-2">
                            <div class="mb-3">
                                <label for="website" class="form-label">Website</label>
                                <input type="text" class="form-control" placeholder="Enter Website" id="website" value="{{ $company->website }}" name="website">
                            </div>
                        </div><!--end col-->
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Enter address" id="address" value="{{ $company->address }}" name="address">
                            </div>
                        </div><!--end col-->
                        ...
                        <div class="col-lg-2 mb-3">
                            ...
                            <div class="form-check form-switch form-switch-custom form-switch-primary">
                                <input class="form-check-input" type="checkbox" name="is_b2b" role="switch" id="isB2B" {{ $company->is_b2b ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-2 mb-3">
                            ...
                            <!-- Custom Switches -->
                            <div class="form-check form-switch form-switch-custom form-switch-primary">
                                <input class="form-check-input" type="checkbox" name="is_active" role="switch" id="isActive" {{ $company->is_active ? 'checked' : '' }}>
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body" id="bank-details-container">
                    @foreach ($company->bankDetails as $key => $bank)

                        <div class="row" id="bank_details_{{$key + 1}}">
                            <div class="col-lg-2">
                                <div class="mb-3">
                                    <label for="bank_name" class="form-label">Bank Name <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="Enter Bank Name" id="bank_name" value="{{ $bank->bank_name }}" name="bank[{{ $key + 1 }}][bank_name]" max="100" required>
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-lg-2">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Account Number" id="account_number" value="{{ $bank->account_number }}" name="bank[{{ $key + 1 }}][account_number]" max="50" required>
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-lg-2">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Account Holder Name" id="account_holder_name" value="{{ $bank->account_holder_name }}" name="bank[{{ $key + 1 }}][account_holder_name]" max="100" required>
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-lg-2">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Short Code" id="sort_code" value="{{ $bank->sort_code }}" name="bank[{{ $key + 1 }}][sort_code]" max="20">
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-lg-2">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Branch Name" id="branch_name" value="{{ $bank->branch_name }}" name="bank[{{ $key + 1 }}][branch_name]">
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-lg-2">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Bank Address" id="bank_address" value="{{ $bank->bank_address }}" name="bank[{{ $key + 1 }}][bank_address]">
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Remarks" id="remarks" value="{{ $bank->remarks }}" name="bank[{{ $key + 1 }}][remarks]">
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-lg-2 mb-3">
                                ...
                                <!-- Custom Switches -->
                                <div class="form-check form-switch form-switch-custom form-switch-primary">
                                    <input class="form-check-input" type="checkbox" name="bank[{{ $key + 1 }}][is_active]" role="switch" id="isActive" {{ $bank->is_active ? 'checked' : '' }}>
                                    <label class="form-check-label" for="isActive">Yes</label>
                                </div>
                            </div>
                            ...
                            <input type="hidden" name="bank[{{ $key + 1 }}][id]" value="{{ $bank->id }}">
                        </div>
                    @endforeach
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control ckeditor-classic" id="invoice_terms_conditions" name="invoice_terms_conditions" rows="10" placeholder="Enter Terms & Conditions"> {{ $company->invoice_terms_conditions }} </textarea>
                        </div>
                    </div>
                </div>
                <!-- end card body -->
...
<script>
    ...
    let bankCounter = {{ count($company->bankDetails)}}; // Starting with 1 for the first bank details
