...
@endsection
                                ...
                                @foreach ($groupedRoutes as $prefix => $routes)
                                    <tr>
                                        <td colspan="4" class="table-active fw-bold">
                                            Prefix: <span class="text-primary">{{ $prefix === '/' ? 'Root' : $prefix }}</span>
                                        </td>
                                    </tr>
    ...
    <form action="{{ route('hrm.save-role-acl') }}" method="post" enctype="multipart/form-data">
        @csrf
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="select2 form-control-sm" id="module" name="module">
                                    ...
                                    @foreach ($modules as $module)
                                        <option value="{{ $module->id }}" data-link="{{ $module->module_link }}">{{ $module->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div><!--end col-->
