<form action="{{ route('employee-search') }}" method="post" id="employee-search">
    @csrf
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="filters-offcanvas">
        <div class="d-flex align-items-center bg-primary bg-gradient p-3 offcanvas-header">
            <h5 class="m-0 me-2 text-white">Employee Finder</h5>
        ...
        <div class="offcanvas-body p-0">
            <div data-simplebar class="h-100">
                <div class="p-4">
                    <h6 class="mb-0 fw-semibold text-uppercase">Search Employee</h6>
                    <p class="text-muted">Search Employee By Any Input Field</p>
        ...
        <div class="offcanvas-footer border-top p-3 text-center">
            <div class="row">
                <div class="col-6">
                    <a href="{{ route('all-employees') }}" class="btn btn-light w-100" id="reset-layout">Reset</a>
                </div>
                <div class="col-6">
                    <button type="submit" class="btn btn-primary w-100" id="employee-search">Search</button>
                </div>
            </div>
        </div>
    </div>
