...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-xl-6 col-md-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Assignment Details</h4>
                </div><!-- end card header -->
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Assigned Business Customers</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td>{{ $data->companies->count() > 0 ? $data->companies->pluck('name')->implode(', ') : 'N/A' }}</td>
                                                <td>{{ $data->user->modules->count() > 0 ? $data->user->modules->pluck('name')->implode(', ') : 'N/A' }}</td>
                                                <td>{{ $data->user->businessCustomers->count() > 0 ? $data->user->businessCustomers->pluck('name')->implode(', ') : 'N/A' }}</td>
                                            </tr><!-- end -->
                                        </tbody><!-- end tbody -->
                                    </table><!-- end table -->
                                </div>
