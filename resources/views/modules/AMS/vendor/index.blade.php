                            ...
                            <tbody>
                                @foreach ($vendors as $vendor)
                                    <tr>
                                        ...
                                        <td>{{ collect($vendor['supplies'])->pluck('supplies')->implode(', ') }}</td>
                                        <td><span class="badge {{($vendor['is_active'] == 1 ? 'bg-success' : 'bg-danger')}}">{{ ($vendor['is_active'] == 1 ) ? 'Active' : 'In-Active' }}</span></td>
                                        <td>{{userDetails( $vendor['created_by'])->name}}</td>
                                        ...
                                        {{-- <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a href="javascript:void(0)" class="dropdown-item text-primary" onclick="view({{ $vendor['id'] }})"><i class="ri-eye-fill align-bottom me-2"></i> View</a></li>
                                                    <li class="d-none"><a href="javascript:void(0)" class="dropdown-item edit-item-btn text-warning" onclick="edit({{$vendor['id']}})"><i class="ri-pencil-fill align-bottom me-2"></i> Edit</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td> --}}
