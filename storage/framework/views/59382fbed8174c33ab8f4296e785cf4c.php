...
<html>
<head>
    <title>Booking Invoice From <?php echo e($booking->company->name); ?></title>
...
<body>
    <div style="margin-bottom: 20px;">
        ...
        <div style="width: 100%;">
            ...
            <p>Greetings from <?php echo e($booking->company->name); ?></p>
    ...
    <div style="margin-bottom: 20px; display: flex; justify-content: space-between;">
        ...
        <div style="width: 48%;">
            ...
            <h6 style="font-size: 1em; margin: 0px; color: #007bff;"><?php echo e($booking->company->name); ?></h6>

            <p style="margin-bottom: 0;"><?php echo e($booking->company->address); ?></p>

            <p style="margin-bottom: 0;"><strong>Complain Line:</strong> <?php echo e($booking->company->phone); ?></p>

            <p style="margin-bottom: 0;"><strong>Email:</strong> <?php echo e($booking->company->email); ?></p>
        ...
        <div style="width: 48%;">
            ...
            <p style="margin-bottom: 0;"><strong>Invoice Date:</strong> <?php echo e(date('d-m-Y', strtotime($booking->booking_date))); ?></p>

            <p style="margin-bottom: 0;"><strong>Invoice No:</strong> <?php echo e($booking->booking_prefix . $booking->booking_number); ?></p>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tbody style="text-align: left; ">
                        ...
                        <tr>
                            ...
                            <td style="margin-bottom: 0; padding-bottom: 0;"><p style="margin:0px; padding:0px;"><?php echo $booking->flight_pnr; ?></p></td>
                        ...
                        <tr>
                            ...
                            <td><p style="margin:0px; padding:0px;"><?php echo e($booking->user->name); ?></p></td>
            ...
            <?php if(!empty($booking->flights[0]->air_line_name)): ?>
                ...
                <table class="table" style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr class="bg-grey header" style="background: #e4e4e4; font-weight: bold;">
                        <td style="<?php echo e($airline_class); ?>">
                            Airline Locator
                        </td>
                        <td style="<?php echo e($ticket_no_class); ?>">
                            Ticket Number
                        </td>
                        <td>
                            AirLine
            ...
            <div style="width: 100%; margin-bottom: 20px;">
                ...
                <table style="width: 100%; border-collapse: collapse; border: 1px solid black;">
                    ...
                    <?php $__currentLoopData = $booking->hotels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hotel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                <p style="margin-bottom: 0; padding-bottom: 0;"><?php echo e($hotel['hotel_name']); ?></p>
                            </td>
                            <td>
                                <p style="margin-bottom: 0; padding-bottom: 0;"><?php echo e(date('d M Y', strtotime($hotel['check_in_date']))); ?></p>
                            </td>
                            <td>
                                <p style="margin-bottom: 0; padding-bottom: 0;"><?php echo e(date('d M Y', strtotime($hotel['check_out_date']))); ?></p>
                            </td>
                            <td>
                                <p style="margin-bottom: 0; padding-bottom: 0;"><?php echo e($hotel['total_nights']); ?></p>
                            </td>
                            <td>
                                <p style="margin-bottom: 0; padding-bottom: 0;"><?php echo e($hotel['meal_type']); ?></p>
                            </td>
                            <td>
                                <p style="margin-bottom: 0; padding-bottom: 0;"><?php echo e($hotel['room_type']); ?></p>
                            </td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div style="width: 100%; margin-bottom: 20px;">
                ...
                <table style="width: 100%; border-collapse: collapse; border: 1px solid black;">
                    ...
                    <?php $__currentLoopData = $booking->transports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                <p style="margin-bottom: 0; padding-bottom: 0;"><?php echo e($transport['transport_type']); ?></p>
                            </td>
                            <td>
                                <p style="margin-bottom: 0; padding-bottom: 0;"><?php echo e($transport['airport']); ?></p>
                            </td>
                            <td>
                                <p style="margin-bottom: 0; padding-bottom: 0;"><?php echo e($transport['location']); ?></p>
                            </td>
                            <td>
                                <p style="margin-bottom: 0; padding-bottom: 0;"><?php echo e(date('H:i', strtotime($transport['time']))); ?></p>
                            </td>
                            <td>
                                <p style="margin-bottom: 0; padding-bottom: 0;"><?php echo e($transport['car_type']); ?></p>
                            </td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tbody style="text-align: left;">
                        ...
                        <?php if($price->quantity != null): ?>
                            <tr>
                                ...
                                <th style="margin-bottom: 0px; padding-bottom: 0px;"><p style="margin:0px; padding:0px;"><?php echo e($price->booking_type); ?> </p></th>

                                <th colspan="3" style="margin-bottom: 0px; padding-bottom: 0px;"><p style="margin:0px; padding:0px;"> <?php echo e($price->quantity . ' * ' . $price->sale_cost); ?></p></th>

                                <td style="margin-bottom: 0px; padding-bottom: 0px;"><p style="margin:0px; padding:0px;">:</p></td>

                                <td style="margin-bottom: 0px; padding-bottom: 0px;"><p style="margin:0px; padding:0px;"><?php echo e($booking->currency . $price->total); ?></p></td>
                        ...
                        <?php if(count($booking->otherCharges) > 0): ?>
                            <?php $__currentLoopData = $booking->otherCharges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $other_charge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <th style="margin-bottom: 0px; padding-bottom: 0px;"><p style="margin:0px; padding:0px;"><?php echo e($other_charge->charges_type); ?> </p></th>
                                    ...
                                    <td style="margin-bottom: 0px; padding-bottom: 0px;"><p style="margin:0px; padding:0px;"><?php echo e($booking->currency . $other_charge->amount); ?></p> </td>
                        ...
                        <tr>
                            ...
                            <td style="margin-bottom: 0px; padding-bottom: 0px;"><p style="margin:0px; padding:0px;"><?php echo e($booking->currency . $booking->total_sales_cost); ?></p> </td>
                        ...
                        <tr>
                            ...
                            <td style="margin-bottom: 0px; padding-bottom: 0px;"><p style="margin:0px; padding:0px;"><?php echo e($booking->currency . $booking->deposite_amount); ?></p> </td>
                        ...
                        <tr>
                            ...
                            <td style="margin-bottom: 0px; padding-bottom: 0px;"><p style="margin:0px; padding:0px;"><?php echo e($booking->currency . $booking->balance_amount); ?></p> </td>
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $booking->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pay_key => $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td><p style="margin:0px; padding:0px;"><?php echo e(date('d M Y', strtotime($payment->payment_on))); ?></p></td>

                            <td><p style="margin:0px; padding:0px;"><?php echo e($payment->payment_method); ?></p></td>

                            <td><p style="margin:0px; padding:0px;"><?php echo e($booking->currency . ' ' . number_format($payment->reciving_amount, 2)); ?> <?php if($payment->cc_charges > 0): ?>
                                <?php echo e(" (+ ".number_format($payment->cc_charges, 2) ." CC)"); ?>
    ...
    <div style="margin-top: 20px;">
        ...
        <h6 style="font-size: 1em; margin: 0px; margin-bottom: 10px; color: #007bff;"><?php echo e($booking->user->name); ?></h6>
        <h6 style="font-size: 1em; margin: 0px; margin-bottom: 10px;">Sales Department</h6>

        <p style="margin-bottom: 0;"><?php echo e($booking->company->name); ?></p>

        <p style="margin-bottom: 0; margin-top:0px;"><?php echo e($booking->company->address); ?></p>

        <p style="margin-bottom: 0; margin-top:0px;"><strong>Complain Line:</strong> <?php echo e($booking->company->phone); ?></p>

        <p style="margin-bottom: 0; margin-top:0px;"><strong>Email:</strong> <?php echo e($booking->company->email); ?></p>

    </div>

</body>
</html>
<?php /**PATH /home4/bestumr2/public_html/mis.bestumrahpackagesuk.com/resources/views/emails/invoice.blade.php ENDPATH**/ ?>