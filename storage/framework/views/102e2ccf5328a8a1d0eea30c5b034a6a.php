...
<script>
    ...
    $('#addInternalComments').submit(function(event) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('crm.save-booking-internal-comments')); ?>",
            data: $(this).serialize(),
...
<?php /**PATH /home4/bestumr2/public_html/mis.bestumrahpackagesuk.com/resources/views/modules/CRM/booking/modals/add-booking-internal-comments.blade.php ENDPATH**/ ?>