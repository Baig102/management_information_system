        ...
        <table class="table table-bordered table-nowrap table-sm">
            ...
            <tbody>
                <tr>
                    ...
                    <td><span class="text-danger"><?php echo e($booking->currency . ' ' . $booking->balance_amount); ?></span></td>
    ...
    $(document).ready(function() {
        ...
        $('#otherChargesForm').submit(function(event) {
            ...
            event.preventDefault();
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('crm.save-other-charges')); ?>",
                    data: $(this).serialize(),
...
<?php /**PATH /home4/bestumr2/public_html/mis.bestumrahpackagesuk.com/resources/views/modules/CRM/booking/modals/add-other-charges.blade.php ENDPATH**/ ?>