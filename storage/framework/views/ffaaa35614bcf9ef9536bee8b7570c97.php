...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->stopSection(); ?>
    <form action="<?php echo e(route('crm.save-booking')); ?>" id="saveBookingForm" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                ...
                <div class="card">
                    <div class="card-header align-items-center d-flex p-2">
                        ...
                        <div class="flex-shrink-0">
                            <a href="javascript:void(0)" onclick="add_pnr_rows()" class="btn btn-soft-success btn-sm float-end btn-label">
                                <i class="ri-plane-fill label-icon align-middle fs-16 me-2"></i> Add Pnr</a>
                                
                        </div>
                    </div><!-- end card header -->
                    <div class="card-body"  id="pnr_details">
                        <input type="hidden" name="pnr_count" id="pnr_details_count" value="1">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                ...
                                <select class="select2 form-control-sm" id="company" name="company_id" data-placeholder="Select Company" required>
                                    ...
                                    <option value="<?php echo e($assiCompany->id); ?>"><?php echo e($assiCompany->name); ?></option>
                            ...
                            <div class="col-lg-2">
                                ...
                                <select class="select2 form-control-sm" id="businessCustomer" name="business_customer_id" data-placeholder="Select Business Customer">
                                    <option></option>
                                    ...
                                    <option value="<?php echo e($businessCustomer->id); ?>"><?php echo e($businessCustomer->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-2">
                                ...
                                <input type="text" name="booking_date" value="<?php echo e(date('Y-m-d')); ?>" placeholder="DD-MM-YYYY" class="form-control flatpickr-date" data-provider="flatpickr" id="booking_date" autocomplete="off" required>
                            </div>

                            <div class="col-lg-2">
                                <label for="ticket_deadline" class="form-label">Ticketing Deadline<span class="text-danger"> *</span></label>
                                <input type="text" name="ticket_deadline" value="<?php echo e(date('Y-m-d')); ?>" placeholder="DD-MM-YYYY" class="form-control flatpickr-date" data-provider="flatpickr" id="ticket_deadline" autocomplete="off" required>
                            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex p-2">
                        ...
                        <div class="flex-shrink-0">
                            <a href="javascript:void(0)" onclick="add_passenger_rows()" class="btn btn-soft-success btn-sm float-end btn-label" id=""><i class="ri-shield-user-line label-icon align-middle fs-16 me-2"></i> Add Passenger</a> <!--add_passenger_button-->
                        </div>
                    </div><!-- end card header -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex p-2">
                        <h4 class="card-title mb-0 flex-grow-1">Visa Details</h4>
                        <div class="flex-shrink-0">
                            <a href="javascript:void(0)" onclick="add_visa_rows()"
                                class="btn btn-soft-success btn-sm float-end btn-label"><i
                                    class="ri-stack-line label-icon align-middle fs-16 me-2"></i> Add Visa</a>
                        </div>
                    </div><!-- end card header -->
                    <div class="card-body" id="visa_details">
                        <input type="hidden" name="visa_count" id="visa_details_count" value="1">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex p-2">
                        ...
                        <div class="flex-shrink-0">
                            <a href="javascript:void(0)" onclick="add_flight_rows()" class="btn btn-soft-success btn-sm float-end btn-label" id="add_flight_button"><i
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body" id="pricing_breakdown_details">
                        <?php echo $__env->make('modules.CRM.booking.inc.booking-pricing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="deposit_date" value="<?php echo e(today()); ?>" placeholder="DD-MM-YYYY" class="form-control flatpickr-date" data-provider="flatpickr" id="deposit_date" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 mb-3">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body" id="comments">
                        <textarea name="comments" id="editor_1" class="form-control" rows="4"></textarea>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->startSection('filters-offcanvas'); ?>
    <!-- Filters -->
    <?php echo $__env->make('modules.CRM.booking.inc.filters-offcanvas', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('script'); ?>
    <script>
        $(function() {
            ...
            initializeSelect2WithAjax('#ticket_supplier', '<?php echo e(route('crm.get-vendors','Ticket')); ?>', 'Search for Ticket Supplier');
        ...
        function add_pnr_rows(){
            pnr_count = $('#pnr_details_count').val();
            //console.log(pnr_count);
            const $pnrDetails = $('#pnr_details');

            // Create a div for each date
            const $div = $(`<div class="row clearfix pnr_info mb-3" id="pnr_info_${pnr_count}"></div>`);

            // Create date input field
            const $dateInput = $(`

                <div class="col-lg-8">
                    <label for="pnr_${pnr_count}" class="form-label">PNR<span class="text-danger"> *</span></label>
                    <textarea ame="pnrData[${pnr_count}][pnr]" class="form-control" placeholder="PNR" id="pnr_${pnr_count}" autocomplete="off" rows="8" required></textarea>
                </div>
                <div class="col-lg-2 col-md-6">
                    <label>Supplier<span class="text-danger"> *</span></label>
                    <select class="flight_supplier" id="pnrFlightSupplier_${pnr_count}" name="pnrData[${pnr_count}][supplier]" data-placeholder="select flight supplier" required></select>
                </div>
                <div class="col-lg-2">
                    <label for="pnr_${pnr_count}" class="form-label">Action<span class="text-danger"> *</span></label>
                    <div>
                        <button type="button" class="btn btn-info btn-label waves-effect waves-light btn-soft-info btn-sm clone_row" id="pnrFetchDetails_${pnr_count}" onclick="getPnrDetails(${pnr_count})"><i class="ri-inbox-archive-line label-icon align-middle fs-16 me-2"></i>Fetch Details</button>

                        <button type="button" class="btn btn-danger btn-label waves-effect waves-light btn-soft-danger btn-sm remove_pnr_row_${pnr_count}" onclick="remove_pnr_row(pnr_info_${pnr_count}, this.id)"><i class="ri-indeterminate-circle-line label-icon align-middle fs-16 me-2"></i>Remove</button>
                    </div>

                </div>
                <input type="hidden" name="pnrData[${pnr_count}][pnr_key]" value='' id="pnr_data_key_${pnr_count}">
                <input type="hidden" name="pnrData[${pnr_count}][pnr_response]" value='' id="pnr_json_data_${pnr_count}">
                <hr class="mt-4">
            `);
            $div.append($dateInput);
            // Append the div to the container
            $pnrDetails.append($div);
            $('#pnr_details_count').val(parseInt(pnr_count) + +1);
            initializeSelect2WithAjax('#pnrFlightSupplier_' + pnr_count, '<?php echo e(route('crm.get-vendors')); ?>', 'Search for Vendor');
        };

        function remove_pnr_row(key, id){
            //console.log(key, id);

            Swal.fire({
                title: 'Are you sure?',
                text: "Are you sure to delete this PNR from booking!",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    if (id != '') {
                    $("#passenger_details ." + id).each(function() {
                        // Remove the current row element with the matching 'key' class
                        $(this).remove();
                    });

                    $("#flight_details ." + id).each(function() {
                        // Remove the current row element with the matching 'key' class
                        $(this).remove();
                    });
                }
        ...
        function add_passenger_rows() {
            ...
            const $dateInput = $(`
                <div class="col-lg-2">
                    ...
                    <select class="select2 form-control-sm title" id="title_${pass_count}" name="passenger[${pass_count}][title]">
                ...
                <div class="col-lg-2">
                    ...
                    <input type="text" name="passenger[${pass_count}][first_name]" value="" class="form-control first_name" placeholder="First Name" id="first_name_${pass_count}" autocomplete="off" required>
                </div>
                <div class="col-lg-2">
                    <label for="middle_name_${pass_count}" class="form-label">Middle Name</label>
                    <input type="text" name="passenger[${pass_count}][middle_name]" value="" class="form-control middle_name" placeholder="Middle Name" id="middle_name_${pass_count}" autocomplete="off">
                </div>
                <div class="col-lg-2">
                    <label for="last_name_${pass_count}" class="form-label">Last Name</label>
                    <input type="text" name="passenger[${pass_count}][last_name]" value="" class="form-control last_name" placeholder="Last Name" id="last_name_${pass_count}" autocomplete="off">
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-2 mt-3">
                    <button type="button" class="btn btn-danger btn-label waves-effect waves-light btn-soft-danger btn-sm clone_row mt-4 remove_row" onclick="remove_row(passenger_info_${pass_count})"><i class="ri-indeterminate-circle-line label-icon align-middle fs-16 me-2"></i>Remove</button>
                </div>
                <input type="hidden" name="passenger[${pass_count}][pnr_key]" id="pnr_key_${pass_count}" class="pnr_key">
                <hr class="mt-4">
            `);
            $div.append($dateInput);
        ...
        function add_hotel_rows() {
            ...
            const $dateInput = $(`
                ...
                <div class="col-lg-2 col-md-6 mb-3">
                    ...
                    <input type="text" name="hotel[${hotel_count}][deadline]" value="" placeholder="DD-MM-YYYY" class="form-control" data-provider="flatpickr" id="hotel_deadline_${hotel_count}" autocomplete="off" required>
                </div>
                <div class="col-lg-2 col-md-6">
                    <label>Supplier<span class="text-danger"> *</span></label>
            ...
            $(document).ready(function() {
                ...
                var hotelDeadline = flatpickr("#hotel_deadline_" + hotel_count, {
                    dateFormat: "Y-m-d",
                    minDate: "today",
                });
            });
            ...
            initializeSelect2WithAjax('#hotelSupplier_'+ hotel_count, '<?php echo e(route('crm.get-vendors','Hotels')); ?>', 'Search for Vendor');
            checkCheckboxState();
        };
        ...
        function add_transport_rows() {
            ...
            initializeSelect2WithAjax('#transportSupplier_' + transport_count, '<?php echo e(route('crm.get-vendors')); ?>', 'Search for Vendor');
            initializeSelect2WithAjax('#transportAirport_' + transport_count, '<?php echo e(route('crm.get-airports')); ?>', 'Search for airports');
        ...
        function add_flight_rows() {
            ...
            const $dateInput = $(`
                <div class="col-lg-2 col-md-2 mb-3">
                    ...
                    <input type="text" class="form-control gds_no" name="flights[${flight_count}][gds_no]" placeholder="GDS Ref. Number">
                </div>
                <div class="col-lg-2 col-md-2 mb-3">
                    <label>Airline Locator</label>
                    <input type="text" class="form-control airline_locator" name="flights[${flight_count}][airline_locator]" placeholder="Airline Locator">
                </div>
                ...
                <div class="col-lg-2 col-md-2 mb-3">
                    ...
                    <input type="text" class="form-control flight_number" name="flights[${flight_count}][flight_number]" placeholder="Flight No">
                </div>
                <div class="col-lg-2 col-md-2 mb-3">
                ...
                <div class="col-lg-2 col-md-2 mb-3">
                    ...
                    <input type="text" class="form-control departure_date" id="departure_date_${flight_count}" name="flights[${flight_count}][departure_date]" value="" placeholder="Departure Date">
                </div>

                <div class="col-lg-2 col-md-2 mb-3">
                    <label>Arrivel Date</label>
                    <input type="text" class="form-control arrival_date" id="arrival_date_${flight_count}" name="flights[${flight_count}][arrival_date]" value="" placeholder="Arrivel Date">
                </div>

                <div class="col-lg-2 col-md-2 mb-3">
                    <label>Departure Time</label>
                    <input type="time" class="form-control departure_time" id="departure_time_${flight_count}" name="flights[${flight_count}][departure_time]" value="" placeholder="Departure Time">
                </div>

                <div class="col-lg-2 col-md-2 mb-3">
                    <label>Arrivel Time</label>
                    <input type="time" class="form-control arrival_time" id="arrival_time_${flight_count}" name="flights[${flight_count}][arrival_time]" value="" placeholder="Arrivel Time">
                </div>
                ...
                <div class="col-lg-2 col-md-2 mb-3">
                    <label>Booking Class</label>
                    <input type="text" class="form-control booking_class" id="booking_class_${flight_count}" name="flights[${flight_count}][booking_class]" value="" placeholder="Select Booking Class" required>
                </div>
                ...
                <div class="col-lg-2 col-md-2 mb-3">
                    ...
                    <select class="select2 form-control form-control-sm" name="flights[${flight_count}][number_of_baggage]" required="" data-placeholder="select # of Baggage">
                        <option>0 PC</option>
                        <option>01 PC x 23kg</option>
                        <option>02 PC x 23kg</option>
                        <option>03 PC x 23kg</option>
                        <option>15 KG</option>
                        <option>20 KG</option>
                        <option>23 KG</option>
                        <option>25 KG</option>
                ...
                <div class="col-lg-2 col-md-6">
                    <label>Supplier<span class="text-danger"> *</span></label>
                    <select class="flight_supplier" id="flightsSupplier_${flight_count}" name="flights[${flight_count}][supplier]" data-placeholder="Select flight supplier" required></select>
                </div>

                <div class="col-lg-1 col-md-1 mb-3">
                        <button type="button"
                            class="btn btn-danger btn-label waves-effect waves-light btn-soft-danger btn-sm clone_row mt-4 remove_flight" onclick="remove_row(flight_info_${flight_count})"><i class="ri-indeterminate-circle-line label-icon align-middle fs-16 me-2"></i>Remove</button>
                </div>
                <input type="hidden" name="flights[${flight_count}][pnr_key]" id="pnr_key_${flight_count}" class="pnr_key">
            `);
            ...
            initializeSelect2WithAjax('#departure_airport_' + flight_count, '<?php echo e(route('crm.get-airports')); ?>',
                'Search for airports');
            initializeSelect2WithAjax('#arrival_airport_' + flight_count, '<?php echo e(route('crm.get-airports')); ?>',
                'Search for airports');
            initializeSelect2WithAjax('#air_line_name_' + flight_count, '<?php echo e(route('crm.get-airlines')); ?>',
                'Search for airlines');

            initializeSelect2WithAjax('#flightsSupplier_' + flight_count, '<?php echo e(route('crm.get-vendors')); ?>', 'Search for Vendor');
        ...
        function add_visa_rows() {

            //$('.select').select2();

            visa_count = $('#visa_details_count').val();

            $("#visa_info_" + visa_count + " select").select2('destroy');

            const $visaContainer = $('#visa_details');
            //$visaContainer.empty();

            // Create a div for each date
            const $div = $(`<div class="row clearfix visa_info mb-3" id="visa_info_${visa_count}"></div>`);

            // Create date input field
            const $dateInput = $(`
                <div class="col-lg-2 col-md-6">
                    <label>Visa Category<span class="text-danger"> *</span></label>
                    <select class="visa_category" id="visaCategory_${visa_count}" name="visa[${visa_count}][visa_category]" data-placeholder="select visa visa category" required></select>
                </div>
                <div class="col-lg-2 col-md-6">
                    <label>Visa Country<span class="text-danger"> *</span></label>
                    <select class="visa_country" id="visaCountry_${visa_count}" name="visa[${visa_count}][visa_country]" data-placeholder="select visa visa country" required></select>
                </div>
                <div class="col-lg-2 col-md-6 mb-3">
                ...
                <div class="col-lg-2 col-md-6 mb-3">
                    <label>Sale Cost<span class="text-danger"> *</span></label>
                    <input type="number" class="form-control visa_sale_cost" name="visa[${visa_count}][sale_cost]" value="" placeholder="Sale Cost" step="0.01" required="" onkeyup="calculateVisaPricing()">
                </div>
                <div class="col-lg-2 col-md-6 mb-3">
                    <label>Net Cost<span class="text-danger"> *</span></label>
                    <input type="number" class="form-control visa_net_cost" name="visa[${visa_count}][net_cost]" value="" placeholder="Net Cost" step="0.01" required="" onkeyup="calculateVisaPricing()">
                </div>
                <div class="col-lg-2 col-md-6">
                    <label>Supplier<span class="text-danger"> *</span></label>
                    <select class="visa_supplier" id="visaSupplier_${visa_count}" name="visa[${visa_count}][supplier]" data-placeholder="select visa supplier" required></select>
                </div>
                <div class="col-lg-2 col-md-6 mb-3">
                    <label>Remarks</label>
                ...
                <div class="col-lg-2 col-md-6 mb-3">
                    <div class="col-lg-4 col-md-6 mb-3">
                        <button type="button" class="btn btn-danger btn-label waves-effect waves-light btn-soft-danger btn-sm clone_row mt-4" onclick="remove_row(visa_info_${visa_count}, 'visa')"><i class="ri-indeterminate-circle-line label-icon align-middle fs-16 me-2"></i>Remove</button>
                    </div>
                </div>
            `);
            ...
            $("#transport_info_" + visa_count + " select").select2();

            $('#visa_details_count').val(parseInt(visa_count) + +1);

            initializeSelect2WithAjax('#visaCategory_' + visa_count, '<?php echo e(route('crm.get-visa-categories')); ?>', 'Visa Category');
            initializeSelect2WithAjax('#visaCountry_' + visa_count, '<?php echo e(route('crm.get-countries')); ?>', 'Visa Country');
            initializeSelect2WithAjax('#visaSupplier_' + visa_count, '<?php echo e(route('crm.get-vendors')); ?>', 'Search for Vendor');
        ...
        $(document).ready(function() {
            $('#saveBookingForm').on('submit', function(e) {
                let totalNetCost = parseFloat($('#total_net_price').val());

                // Check if totalNetCost is greater than zero
                if (isNaN(totalNetCost) || totalNetCost <= 0) {
                    e.preventDefault(); // Prevent form submission
                    Swal.fire(
                            'Warning!',
                            'Total Net Cost must have a valid value.',
                            'warning'
                        );
                    //$('#total_net_cost').focus();
                }
                ...
                $('.cleave-date').each(function () {
                    ...
                    // Skip validation if the input is blank
                    if (dateValue.trim() === '') {
                        return true; // Continue to the next `.cleave-date` input
                    }
                    ...
                    if (!dateRegex.test(dateValue)) {
                        ...
                        Swal.fire(
                            ...
                            `Please enter a valid date in DD-MM-YYYY format in ${dateInput.attr('id')}.`,
                            'error'
                        );
                        e.preventDefault(); // Prevent form submission
                        dateInput.focus(); // Focus on the invalid date input
                        return false; // Break out of the `.each` loop
                    }

                    // Further validate if the date is real
                    ...
                    if (!isValidDate) {
                        ...
                        Swal.fire(
                            'Invalid Date of Birth!',
                            `The date "${dateValue}" is not a real date in ${dateInput.attr('id')}.`,
                            'error'
                        );
                        e.preventDefault(); // Prevent form submission
                        dateInput.focus(); // Focus on the invalid date input
                ...
                if (!isDateValid) {
                    return; // Exit early if any date is invalid
                }
            });
        });
...
<?php echo $__env->make('layouts.master-crm', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/bestumr2/public_html/mis.bestumrahpackagesuk.com/resources/views/modules/CRM/booking/create-pnr.blade.php ENDPATH**/ ?>