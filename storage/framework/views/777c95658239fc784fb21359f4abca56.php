            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarEmployees">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('hrm.employee-register')); ?>" class="nav-link">New Employee</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('hrm.all-emp')); ?>" class="nav-link">Employees List</a>
                            </li>
                        </ul>
                    </div>
                </li> <!-- end Dashboard Menu -->
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarCompanies">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('hrm.create-company')); ?>" class="nav-link">New Company</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('hrm.company-list')); ?>" class="nav-link">Companies List</a>
                            </li>
                        </ul>
                    </div>
                </li> <!-- end Dashboard Menu -->
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarAcl">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('hrm.employee-role')); ?>" class="nav-link">Create Role</a>
                            </li>
...
<?php /**PATH /home4/bestumr2/public_html/mis.bestumrahpackagesuk.com/resources/views/layouts/inc/hrm/sidebar.blade.php ENDPATH**/ ?>