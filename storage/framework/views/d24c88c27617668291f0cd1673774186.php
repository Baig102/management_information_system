...
<form id="installmentForm">
    ...
    <div class="modal-body">
        ...
        <table class="table table-bordered table-nowrap table-sm">
            ...
            <tbody>
                <tr>
                    ...
                    <td><span class="text-danger"><?php echo e($booking->currency . ' ' . number_format($booking->balance_amount, 2)); ?></span>
        ...
        <?php echo e($booking->total_installment); ?>
            ...
            <tbody>
                <?php $__currentLoopData = $booking->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><span class="text-success"><?php echo e($booking->currency . ' ' . number_format($payment->reciving_amount, 2)); ?></span>
                        </td>
                        <td><span class="text-danger"><?php echo e($booking->currency . ' ' . number_format($payment->remaining_amount, 2)); ?></span>
                        </td>
        ...
        <?php else: ?>
            <?php if($booking->installmentPlan->count() <= 0): ?>
                <?php if($booking->total_installment <= 0): ?>
                <div class="alert alert-warning alert-dismissible bg-warning text-white alert-label-icon fade show material-shadow"
                role="alert">
                    <i class="ri-alert-line label-icon"></i><strong>Warning</strong> - Please update total number of intallments...
                </div>
                <?php else: ?>
                    <?php $instalment_amount = $booking->balance_amount / $booking->total_installment; ?>
                    <?php for($i = 1; $i <= $booking->total_installment; $i++): ?>
                        <div class="row clearfix hotel_info mb-1" id="installment_plan">

                            <div class="col-lg-4 col-md-6">
                                <label>Installment Number</label>
                                <input type="text" class="form-control"
                                    name="installment[<?php echo e($i); ?>][installment_number]"
                                    value="<?php echo e($i); ?>" placeholder="Installment Number" readonly>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <label>Installment Due Date</label>
                                <input type="text" class="form-control flatpickr due_date flatpickr-date"
                                    data-provider="flatpickr" autocomplete="off" id="dueDate_<?php echo e($i); ?>"
                                    name="installment[<?php echo e($i); ?>][due_date]" value=""
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <input type="number" class="form-control installment_amount"
                                    name="installment[<?php echo e($i); ?>][amount]" value="<?php echo e(round($instalment_amount,2)); ?>"
    ...
    $(document).ready(function() {
        ...
        $('#installmentForm').submit(function(event) {
            ...
            if (Math.round(totalInstallmentAmount) !== balance_amount) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('crm.save-installment-plan')); ?>",
                    data: $(this).serialize(),
...
<?php /**PATH /home4/bestumr2/public_html/mis.bestumrahpackagesuk.com/resources/views/modules/CRM/booking/modals/add-installment-plan.blade.php ENDPATH**/ ?>