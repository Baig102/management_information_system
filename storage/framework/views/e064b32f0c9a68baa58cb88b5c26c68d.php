...
<form id="inquiryReAssignmentForm">
    <?php echo csrf_field(); ?>
    <div class="modal-header border-bottom border-2 py-2 bg-secondary-subtle">
        <h5 class="modal-title" id="fullscreeexampleModalLabel">Re Assign Inquiry | <?php echo e($inquiry->company_name.' '.$inquiry->source.' Inquiry'); ?></h5>
    ...
    <div class="modal-body">
         ...
         <?php if($inquiry->inquiry_assignment_status !== 2): ?>
            <div class="alert alert-warning alert-dismissible bg-warning text-white alert-label-icon fade show material-shadow"
                role="alert">
                <i class="ri-alert-line label-icon"></i><strong>Warning</strong> - This inquiry is pending...
            </div>
        <?php else: ?>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="alert alert-warning alert-border-left alert-dismissible fade show material-shadow" role="alert">
                        <i class="ri-alert-line me-3 align-middle"></i> <strong>Warning</strong> - This inquiry is assigned to <?php echo e($inquiries_assigned_details['name']); ?> and assigned date and time is: <?php echo e($inquiries_assigned_details['assigned_on']); ?>
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        <select class="form-control ms select2" name="agent_id" id="agent_id" data-placeholder="Select Agent">
                            ...
                            <option value="<?php echo e($user->id); ?>" <?php echo e(($user->id == $inquiry->inquiry_assigned_to) ? "selected" : ""); ?>><?php echo e($user->name); ?></option>
    ...
    <div class="modal-footer">
        ...
        <input type="hidden" name="inquiry_assigment_id" value="<?php echo e($inquiry_assigment->id); ?>">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#inquiryReAssignmentForm').submit(function(event) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('crm.save-re-assign-inquiry')); ?>",
                data: $(this).serialize(),
...
<?php /**PATH /home4/bestumr2/public_html/mis.bestumrahpackagesuk.com/resources/views/modules/CRM/inquiry/modals/inquiry-re-assignment.blade.php ENDPATH**/ ?>