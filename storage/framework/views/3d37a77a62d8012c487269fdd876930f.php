                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="code" class="form-control form-control-icon" id="code"
                                value="<?php echo e(old('code')); ?>" placeholder="Code of Employee">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="name" class="form-control form-control-icon" id="name"
                                value="<?php echo e(old('name')); ?>" placeholder="Name of Employee">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="guardian_name" class="form-control form-control-icon"
                                id="guardian_name" value="<?php echo e(old('guardian_name')); ?>" placeholder="Guardian Name">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-lg-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="cnic" class="form-control form-control-icon cleave-cnic"
                                id="cnic" value="<?php echo e(old('cnic')); ?>" placeholder="CNIC">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-lg-3">
...
<?php /**PATH /home4/bestumr2/public_html/mis.bestumrahpackagesuk.com/resources/views/modules/CRM/booking/inc/filters-offcanvas.blade.php ENDPATH**/ ?>