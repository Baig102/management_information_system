...
<script src="<?php echo e(URL::asset('build/js/select2/select2.min.js')); ?>"></script>
...
<!-- choices.js -->
<script type='text/javascript' src='<?php echo e(URL::asset('build/libs/choices.js/public/assets/scripts/choices.min.js')); ?>'></script>

<script type='text/javascript' src='https://cdn.jsdelivr.net/npm/toastify-js'></script>

<script type='text/javascript' src="<?php echo e(URL::asset('build/libs/flatpickr/flatpickr.min.js')); ?>"></script>
<!-- ckeditor -->
...
<?php /**PATH /home/ashraf/Documents/web_dev/mis/resources/views/layouts/vendor-scripts.blade.php ENDPATH**/ ?>