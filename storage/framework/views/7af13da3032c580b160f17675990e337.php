...
<form action="<?php echo e(route('hrm.employee-save')); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex p-2">
                    ...
                    <div class="flex-shrink-0">
                        <a href="<?php echo e(route('hrm.all-emp')); ?>"
                        ...
                        <div class="col-lg-2">
                            <div class="mb-3">
                                ...
                                <select class="select2 mb-3" name="designation" id="designation" aria-label="Select designation">
                                    ...
                                    <option value="<?php echo e($designation->detail_number.'__'.$designation->name); ?>" <?php echo e(($designation->detail_number == 5) ? "selected" : ""); ?>><?php echo e($designation->name); ?></option>
                        ...
                        <div class="col-lg-2">
                            <div class="mb-3">
                                ...
                                <select class="select2 mb-3" name="team_lead_id" id="team_lead_id" aria-label="Manager / Team Lead">
                                    ...
                                    <option value="<?php echo e($team_lead->user->id); ?>"><?php echo e($team_lead->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div><!--end col-->
...
<?php echo $__env->make('layouts.master-hrm', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/bestumr2/public_html/mis.bestumrahpackagesuk.com/resources/views/modules/HRM/employee/create.blade.php ENDPATH**/ ?>