...
<script>
    ...
    $('#addPnr').submit(function(event) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('crm.save-pnr')); ?>",
            data: $(this).serialize(),
...
<?php /**PATH /home4/bestumr2/public_html/mis.bestumrahpackagesuk.com/resources/views/modules/CRM/booking/modals/add-pnr.blade.php ENDPATH**/ ?>