...
<form id="updateVisaDetails">
    <div class="modal-body" id="visa_details">
        ...
        ?>
        <?php echo csrf_field(); ?>
        <?php $__currentLoopData = $booking->visas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pass_key => $visa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row clearfix visa_info mb-3" id="visaInfo_<?php echo e($visa->id); ?>">
            <div class="col-lg-2 col-md-6">
                ...
                <select class="visa_category select2" id="visaCategory_<?php echo e($visa->id); ?>" name="visa[<?php echo e($visa->id); ?>][visa_category]" data-placeholder="select visa visa category" required>
                    <?php $__currentLoopData = $visaCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a_key => $visa_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($visa_category->name); ?>" <?php echo e(($visa_category->name == $visa->visa_category) ? "selected" : ""); ?>> <?php echo e($visa_category->name); ?> </option>
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <select class="visa_country select2" id="visaCountry_<?php echo e($visa->id); ?>" name="visa[<?php echo e($visa->id); ?>][visa_country]" data-placeholder="select visa visa country" required>
                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c_key => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($country->name); ?>" <?php echo e(($country->name == $visa->visa_country) ? "selected" : ""); ?>> <?php echo e($country->name); ?> </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="col-lg-2 col-md-6 mb-3">
                <label>Number of Pax<span class="text-danger"> *</span></label>
                <input type="number" class="form-control no_of_pax" id="noOfPax_<?php echo e($visa->id); ?>" name="visa[<?php echo e($visa->id); ?>][no_of_pax]" value="<?php echo e($visa->no_of_pax); ?>" placeholder="No Of Pax" required>
            </div>
            <div class="col-lg-2">
                <label for="nationality_<?php echo e($visa->id); ?>" class="form-label">Nationality</label>
                <input type="text" name="visa[<?php echo e($visa->id); ?>][nationality]" value="<?php echo e($visa->nationality); ?>" class="form-control" placeholder="Nationality" id="nationality_<?php echo e($visa->id); ?>" autocomplete="off">
            </div>
            <div class="col-lg-2 col-md-6 mb-3">
                <label>Sale Cost <?php echo $required_check_sales_cost; ?></label>
                <input type="number" class="form-control visa_sale_cost" name="visa[<?php echo e($visa->id); ?>][sale_cost]" value="<?php echo e($visa->sale_cost); ?>" placeholder="Sale Cost" step="0.01" <?php echo $filed_condition_sales_cost; ?>>
            </div>
            <div class="col-lg-2 col-md-6 mb-3">
                <label>Net Cost<span class="text-danger"> *</span></label>
                <input type="number" class="form-control visa_net_cost" name="visa[<?php echo e($visa->id); ?>][net_cost]" value="<?php echo e($visa->net_cost); ?>" placeholder="Net Cost" step="0.01" required="">
            </div>
            <div class="col-lg-2 col-md-6">
            ...
            <div class="col-lg-2 col-md-6 mb-3">
                <label>Remarks</label>
                <input type="text" class="form-control remarks" name="visa[<?php echo e($visa->id); ?>][remarks]" value="<?php echo e($visa->remarks); ?>" placeholder="Remarks">
            </div>
            <div class="col-lg-2 col-md-6 mb-3">
                <div class="col-lg-4 col-md-6 mb-3">
                    <input type="hidden" name="visa[<?php echo e($visa->id); ?>][id]" value="<?php echo e($visa->id); ?>">
                    <button type="button" class="btn btn-danger btn-label waves-effect waves-light btn-soft-danger btn-sm clone_row mt-4" onclick="remove_row('visaInfo_<?php echo e($visa->id); ?>', <?php echo e($visa->id); ?>)"><i class="ri-indeterminate-circle-line label-icon align-middle fs-16 me-2"></i>Remove</button>
                </div>
            </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="modal-footer">
        <input type="hidden" name="visa_count" id="visa_details_count" value="<?php echo e($booking->visas->count()+1); ?>">
        <input type="hidden" name="booking_id" id="booking_id" value="<?php echo e($booking->id); ?>">
        <a href="javascript:void(0)" class="btn btn-warning" id="addHotel" onclick="add_visa_rows(<?php echo e($booking->is_full_package); ?>)"><i class="ri-shield-user-fill me-1 align-middle"></i>Add</a>
...
<script>
    $(function() {
        ...
        $('#extraLargeModal').on('shown.bs.modal', function() {
            ...
            // initializeSelect2WithAjax('.visa_category', '<?php echo e(route('crm.get-visa-categories')); ?>', 'Visa Category');
            // initializeSelect2WithAjax('.visa_country', '<?php echo e(route('crm.get-countries')); ?>', 'Visa Country');
            // initializeSelect2WithAjax('.visa_supplier', '<?php echo e(route('crm.get-vendors')); ?>', 'Search for Vendor');
        });
        ...
        const $dateInput = $(`
            <div class="col-lg-2 col-md-6">
                ...
                <select class="visa_category select2" id="visaCategory_${visa_count}" name="visa[${visa_count}][visa_category]" data-placeholder="select visa visa category" required>
                    <?php $__currentLoopData = $visaCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a_key => $visa_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($visa_category->name); ?>"> <?php echo e($visa_category->name); ?> </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="col-lg-2 col-md-6">
        ...
        if (data_id != null) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route("crm.delete-visa-details", "")); ?>/' + visa_id,
                        type: 'DELETE',
                        data: {
    ...
    $('#updateVisaDetails').submit(function(event) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('crm.update-visa-details')); ?>",
            data: $(this).serialize(),
            success: function(response) {
                // console.log(response);
...
<?php /**PATH /home4/bestumr2/public_html/mis.bestumrahpackagesuk.com/resources/views/modules/CRM/booking/modals/edit-visa.blade.php ENDPATH**/ ?>